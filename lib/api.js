...
/**
 * API container object for API call methods
 *
 * @type {object}
 * @property {Function} get `GET` API call method
 * @property {Function} post `POST` API call method
 * @property {Function} patch `PATCH` API call method
 *
...
/**
 * Curried function for generating methods on the {@link api} object.
 *
 * @type {object}
 * @private
 */
