...
/**
 * Curried function for `getAll` function program rewards.
 *
 ...
 * @property {apiCallback} callback callback Callback that handles the response.
 *
 * @example
...
/**
 * Curried function for `get` function program rewards.
 *
 * @param {number} programId The ID of the reward's parent program.
 *
