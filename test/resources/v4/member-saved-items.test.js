      ...
      it('should pass an object to the callback', () => {
        return new Promise(done => {
          nock(RO.urls.getApiBaseUrl(), {
            ...
            .get('/programs/33/member_saved_items/555')
            .once()
            .reply(200, {
              result: {},
            });

          program.memberSavedItems.get(555, (error, data) => {
      ...
      it('should make an HTTP get request to the correct URL', () => {
        return new Promise(done => {
          const apiCall = nock(RO.urls.getApiBaseUrl(), {
            ...
            .get('/programs/12/member_saved_items/929')
            .once()
            .reply(200, {
              result: {},
            });

          RO.program(12).memberSavedItems.get(929, (error, itemList) => {
            expect(error).toEqual(null);
      ...
      it('should accept an optional params object and pass it on to the RO.api.get() call as query params', () => {
        return new Promise(done => {
          ...
          const scope = nock(RO.urls.getApiBaseUrl(), {
            ...
            .get('/programs/55/member_saved_items/234')
            .query(params)
            .reply(200, {
              result: [],
            });

          RO.program(55).memberSavedItems.get(234, params, (error, itemsList) => {
            expect(error).toEqual(null);
      ...
      it('should pass an object to the callback', () => {
        return new Promise(done => {
          nock(RO.urls.getApiBaseUrl(), {
            ...
            .get('/programs/33/member_saved_items/parameters')
            .once()
            .reply(200, {
              result: {},
            });

          program.memberSavedItems.getParameters((error, data) => {
            expect(typeof data).toBe('object');
      ...
      it('should make an HTTP get request to the correct URL', () => {
        return new Promise(done => {
          const apiCall = nock(RO.urls.getApiBaseUrl(), {
            ...
            .get('/programs/12/member_saved_items/parameters')
            .once()
            .reply(200, {
              result: [],
            });

          RO.program(12).memberSavedItems.getParameters((error, data) => {
            expect(error).toEqual(null);
      ...
      it('should accept an optional params object and pass it on to the RO.api.get() call as query params', () => {
        return new Promise(done => {
          ...
          const scope = nock(RO.urls.getApiBaseUrl(), {
            ...
            .get('/programs/55/member_saved_items/parameters')
            .query(params)
            .reply(200, {
              result: [],
            });

          RO.program(55).memberSavedItems.getParameters(params, (error, data) => {
            expect(error).toEqual(null);
